...
class Fireflies():
    ...
    def __init__(self, params) -> None:
        ...
        self.omegas = np.random.uniform(low=self.p.omega_low, high=self.p.omega_high, size=self.p.num_agents)
        ...
        if flashed:
            ...
            if np.sum(flashed_neighbors) > 0:
                ...
                omega_change = self.p.epsilon * (self.p.omega_common - self.omegas ) \
                                    ...
                                    + gMin * self.phases * (self.p.omega_low - self.omegas )
                omega_change[flashed_neighbors] = 0
    ...
    def simulate(self, num_steps=None):
        ...
        for i in range(num_steps):
            ...
            if i % 100 == 0:
                print(f"flashcount = {self.flashcount}, on step {self.stepcount}")
